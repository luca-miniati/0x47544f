 ...
 */
struct GameState {
    std::pair<double, double> bets = {0, 0};
    double pot = 0, last_raise = 0;
     ...
     * @param pot a double representing the total size of the pot in big blinds.
     ...
     */
    GameState(double pot, std::pair<double, double> bets, double last_raise, bool is_terminal,
              int num_raises, int player_to_act, std::string history);
     ...
     *
     * e.g. "2.0|(2.0, 0)|2|false|1|P2|b(1.0)" would represent the game state after P1 pots it on the
